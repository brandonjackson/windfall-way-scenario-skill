...
description: >
  Full pipeline in one go: brief, concepts, draft, stress test, final Windfall scenario for an AI and economic change workshop. Pick this to start from scratch and get a finished scenario.
---
